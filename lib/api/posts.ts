...
export async function createPost(input: PostInput, authToken?: string) {
  return apiFetch<StrapiSingleResponse<PostWithLocalizations>>(`/api/articles`, {
    method: "POST",
    authToken,
    locale: input.locale,
    body: {
...
export async function updatePost(documentId: string, input: PostInput, authToken?: string) {
  return apiFetch<StrapiSingleResponse<PostWithLocalizations>>(`/api/articles/${documentId}`, {
    method: "PUT",
    authToken,
    locale: input.locale,
    body: {
...
export async function deletePost(documentId: string, authToken?: string) {
  return apiFetch(`/api/articles/${documentId}`, {
    method: "DELETE",
    authToken,
  });
}
